...
The test were run on 19/07/2024 18:54, using the 2024-06-13-beta.1 release of OvertureMap data and the OSM data until 2024/06/07.
...
| **4. Number of connected components**        | *Higashihiroshima* |           28    |           23    |                   5    |
| **4. Number of connected components**        | *Kumamoto*         |          108    |          116    |                   8    |
| **4. Number of connected components**        | *Morioka*          |           31    |           34    |                   3    |
| **4. Number of connected components**        | *Tateyama*         |           25    |           18    |                   7    |
| **4. Number of connected components**        | *Tokyo*            |          253    |          256    |                   3    |
| **5. Number of strong connected components** | *Hamamatsu*        |          101    |          101    |                   0    |
| **5. Number of strong connected components** | *Higashihiroshima* |           67    |           38    |                  29    |
| **5. Number of strong connected components** | *Kumamoto*         |          130    |          159    |                  29    |
| **5. Number of strong connected components** | *Morioka*          |          100    |           61    |                  39    |
| **5. Number of strong connected components** | *Tateyama*         |           32    |           20    |                  12    |
| **5. Number of strong connected components** | *Tokyo*            |          593    |          626    |                  33    |
...
| **7. Overlap indicator (%)**                 | *Hamamatsu*        |          100    |           95.9  |                   4.1  |
| **7. Overlap indicator (%)**                 | *Higashihiroshima* |           99.98 |           91.16 |                   8.82 |
| **7. Overlap indicator (%)**                 | *Kumamoto*         |           99.97 |           94.82 |                   5.15 |
| **7. Overlap indicator (%)**                 | *Morioka*          |           99.95 |           93.13 |                   6.82 |
| **7. Overlap indicator (%)**                 | *Tateyama*         |          100    |           91.58 |                   8.42 |
| **7. Overlap indicator (%)**                 | *Tokyo*            |           99.5  |           94.93 |                   4.57 |
