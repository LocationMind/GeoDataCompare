...
class Criterion(ABC):
    ...
    datasetALayer:lonboard.ScatterplotLayer | lonboard.PathLayer | lonboard.PolygonLayer
    datasetBLayer:lonboard.ScatterplotLayer | lonboard.PathLayer | lonboard.PolygonLayer
    layerType:lonboard.ScatterplotLayer | lonboard.PathLayer | lonboard.PolygonLayer
    
    datasetAOtherGdf:gpd.GeoDataFrame
    datasetBOtherGdf:gpd.GeoDataFrame
    
    datasetAOtherLayers:list[lonboard.ScatterplotLayer | lonboard.PathLayer | lonboard.PolygonLayer]
    datasetBOtherLayers:list[lonboard.ScatterplotLayer | lonboard.PathLayer | lonboard.PolygonLayer]
    otherLayersType: list[lonboard.ScatterplotLayer | lonboard.PathLayer | lonboard.PolygonLayer]
    ...
    def __init__(self,
        ...
        self.datasetAGdf = self._getLayer(self._datasetALayerTemplate.format(area.lower()), engine)
        self.datasetBGdf = self._getLayer(self._datasetBLayerTemplate.format(area.lower()), engine)
        ...
        self.datasetAOtherGdf = [self._getLayer(layerTemplate.format(area.lower()), engine) for layerTemplate in self._datasetAOtherLayerTemplate]
        self.datasetBOtherGdf = [self._getLayer(layerTemplate.format(area.lower()), engine) for layerTemplate in self._datasetBOtherLayerTemplate]
        
        self.datasetAOtherLayers = [self.otherLayersType[index].from_geopandas(gdf) for index, gdf in enumerate(self.datasetAOtherGdf)]
        self.datasetBOtherLayers = [self.otherLayersType[index].from_geopandas(gdf) for index, gdf in enumerate(self.datasetBOtherGdf)]
