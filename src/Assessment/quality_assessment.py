...
for area in listAreas:
    ...
    listClassesOSM = quality.getLengthKilometerPerClass(
        connection, osmSchema, osmEdgeTable
    )
    listClassesOMF = quality.getLengthKilometerPerClass(
        connection, omfSchema, omfEdgeTable
    )
    ...
    OSMValue = quality.getConnectedComponents(
        connection,
        osmSchema,
        osmEdgeTable,
        resultAsTable=resultOSMTable,
        schemaResult=schemaResult,
        nodeTableName=osmNodeTable,
    )
    OMFValue = quality.getConnectedComponents(
        connection,
        omfSchema,
        omfEdgeTable,
        resultAsTable=resultOMFTable,
        schemaResult=schemaResult,
        nodeTableName=omfNodeTable,
    )

    data.append(
        ["**4. Number of connected components**", f"*{area}*", OSMValue, OMFValue]
    )
    ...
    OSMValue = quality.getStrongConnectedComponents(
        connection,
        osmSchema,
        osmEdgeTable,
        resultAsTable=resultOSMTable,
    ...
    OMFValue = quality.getStrongConnectedComponents(
        connection,
        omfSchema,
        omfEdgeTable,
        resultAsTable=resultOMFTable,
    ...
    data.append(
        [
            "**5. Number of strong connected components**",
            f"*{area}*",
            OSMValue,
            OMFValue,
        ]
    ...
    OSMValue = quality.getIsolatedNodes(
        connection,
        osmSchema,
        osmEdgeTable,
        osmNodeTable,
    ...
    OMFValue = quality.getIsolatedNodes(
        connection,
        omfSchema,
        omfEdgeTable,
        omfNodeTable,
    ...
    OSMValue = quality.getOverlapIndicator(
        connection,
        osmSchema,
        osmEdgeTable,
        omfSchema,
    ...
    OMFValue = quality.getOverlapIndicator(
        connection,
        omfSchema,
        omfEdgeTable,
        osmSchema,
    ...
    data.append(["**7. Overlap indicator (%)**", f"*{area}*", OSMValue, OMFValue])
    ...
    OSMValue = quality.getCorrespondingNodes(
        connection,
        osmSchema,
        osmNodeTable,
        omfSchema,
    ...
    OMFValue = quality.getCorrespondingNodes(
        connection,
        omfSchema,
        omfNodeTable,
        osmSchema,
    ...
    data.append(
        ["**8. Number of corresponding nodes**", f"*{area}*", OSMValue[0], OMFValue[0]]
    )
    data.append(
        [
            "**9. Percentage of corresponding nodes (%)**",
            f"*{area}*",
            OSMValue[1],
            OMFValue[1],
        ]
    ...
    OSMValue = quality.getDensityPlaceGrid(
        connection,
        osmSchema,
        osmPlaceTable,
        area=area.capitalize(),
    ...
    OMFValue = quality.getDensityPlaceGrid(
        connection,
        omfSchema,
        omfPlaceTable,
        area=area.capitalize(),
